...
#Create Other OUs
New-ADOrganizationalUnit -Name "UKHO FTP Users" -Path "$($FTPRoot)" -ProtectedFromAccidentalDeletion $False -Description "UKHO FTP Users"
New-ADOrganizationalUnit -Name "UKHO FTP Groups" -Path "$($FTPRoot)" -ProtectedFromAccidentalDeletion $False -Description "UKHO FTP Groups"
...
#Create Other OUs
New-ADOrganizationalUnit -Name "UKHO FTPS Users" -Path "$($FTPSRoot)" -ProtectedFromAccidentalDeletion $False -Description "UKHO FTPS Users"
New-ADOrganizationalUnit -Name "UKHO FTPS Groups" -Path "$($FTPSRoot)" -ProtectedFromAccidentalDeletion $False -Description "UKHO FTPS Groups"
#New-ADOrganizationalUnit -Name "Servers" -Path "$($WVDRoot)" -ProtectedFromAccidentalDeletion $False -Description "WVD Servers"
#New-ADOrganizationalUnit -Name "Session Hosts" -Path "$($WVDRoot)" -ProtectedFromAccidentalDeletion $False -Description "WVD WVD Session Hosts"
